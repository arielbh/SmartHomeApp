...
import 'package:smart_home_app/src/modules/products/shade/views/shade_operate_widget.dart';
import 'package:smart_home_app/src/modules/products/thermo/views/thermo_operate_widget.dart';

class ShadeOperateRoute extends ModuleRoute {

  Widget build(BuildContext context, GoRouterState state) {
    return ShadeOperateWidget(
      deviceId: state.params["deviceId"]!,
    );
  }

  String get screenPath => "/product/shade/operate/:deviceId";
